...
class Game {
    constructor() {
        ...
        this.school = new SchoolView("./assets/Backgrounds/classroom.jpg", this.canvas, this.player, this.mouseListener);
        this.store = new StoreView("./assets/Backgrounds/Store.jpg", this.canvas, this.player, this.mouseListener);
        this.restaurant = new RestaurantView("./assets/Backgrounds/Restaurant.jpg", this.canvas, this.player, this.mouseListener);
